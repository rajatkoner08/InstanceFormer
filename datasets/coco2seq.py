...
class ConvertCocoPolysToMask(object):
    def __init__(self, return_masks=False, dataset_file='ytvis19', ytvis_path=''):
        self.return_masks = return_masks
        if 'ovis' in dataset_file:
            self.category_map = {1: 1, 2: 21, 4: 21, 5: 22, 9: 22, 16: 2, 17: 3, 18: 4,
                                 19: 5, 20: 6, 21: 7, 22: 8, 23: 9, 24: 10, 25: 11}
            # {1: 'Person', 2: 'Bicycle', 4: 'Motorcycle', 5: 'Airplane', 9: 'Boat', 16: 'Bird', 17: 'Cat', 18: 'Dog',
            # 19: 'Horse', 20: 'Sheep', 21: 'Cow', 22: 'Elephant', 23: 'Bear', 24: 'Zebra', 25: 'Giraffe'}
        elif '21' in ytvis_path:
            # ytvis21
            self.category_map = {1: 26, 2: 23, 3: 5, 4: 23, 5: 1, 7: 36, 8: 37, 9: 4, 16: 3, 17: 6, 18: 9, 19: 19,
                                     21: 7, 22: 12, 23: 2, 24: 40, 25: 18, 36: 31, 41: 29, 42: 33, 43: 34, 74: 24}
        else:
            # ytvis19
            self.category_map = {1: 1, 2: 21, 3: 6, 4: 21, 5: 28, 7: 17, 8: 29, 9: 34, 17: 14, 18: 8, 19: 18, 21: 15,
                                 22: 32, 23: 20, 24: 30, 25: 22, 36: 33, 41: 5, 42: 27, 43: 40, 74: 24}
...
def build(image_set, args):
    ...
    if args.dataset_file == 'coco' or args.dataset_file == 'Seq_coco' or 'joint' in args.dataset_file:
        vis = 'ovis' if 'ovis' in args.dataset_file else ('ytvis21' if '21' in args.ytvis_path else 'ytvis19')
        PATHS = {
            # "train": (root / "train2017", root / "annotations" / f'{mode}_train2017.json'),
            "train": (root / "train2017", f'./datasets/coco_keepfor_{vis}.json'),
            "val": (root / "val2017", root / "annotations" / f'{mode}_val2017.json'),
        }
    if args.dataset_file == 'YoutubeVIS':
        PATHS = {
            "train": (root / f'{dataset_type}' / "train" / "JPEGImages",
                      root / "annotations" / f'{dataset_type}' / f'{mode}_train_sub_coco.json'),
            "val": (root / f'{dataset_type}' / "valid" / "JPEGImages",
                    root / "annotations" / f'{dataset_type}' / f'{mode}_val_sub_coco.json'),
        }
