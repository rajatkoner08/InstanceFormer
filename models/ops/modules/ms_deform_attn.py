# ------------------------------------------------------------------------
# InstanceFormer Deformable Attention.
# ------------------------------------------------------------------------
...
class MSDeformAttn(nn.Module):
    def __init__(self, d_model=256, n_levels=4, n_heads=8, n_points=4, mode='encode', online=True):
        """
    ...
    def forward(self, query, query_box, reference_points, input_flatten, input_spatial_shapes, input_level_start_index,
                input_padding_mask=None, pre_sample_ofst=None, dec_sample_loc=None):
        ...
        if self.mode == 'encode':
            ...
            return self.decode_forward(query, reference_points, input_flatten, input_spatial_shapes,
    ...
    def decode_forward(self, query, reference_points, input_flatten, input_spatial_shapes,
                       input_level_start_index, input_padding_mask=None):

        if len(query.shape) == 3:  # first layer
